...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT id_startuper FROM startuper WHERE pseudo=? AND pwrd=?"; // Remplacez 'utilisateurs' par le nom réel de votre table et ajustez les noms des colonnes
    ...
    if ($result) {
        ...
        $startuper_id = $result['id_startuper']; // Utilisez le bon nom de colonne
        
        // Enregistrez l'ID du startuper dans une session
        $_SESSION['startuper_id'] = $startuper_id;
        
        // Redirection vers la page suivante
        header("Location: /projet pweb 2/startuper/startuper-home.php");
...
<head>
    ...
    <link rel="stylesheet" href="../login-capital/login.css">
